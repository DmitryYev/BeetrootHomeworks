...
const BookForm = ({ match, categories, books, addBookAction, editBookAction }) => {
    ...
    function onSubmit(data, e) {
        ...
        if (bookForEdit) {
            data = { ...data, _id: bookForEdit._id }
            editBookAction(data)
        } else addBookAction(data)
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="col-md-5">
            ...
            <div className="form-group">
                ...
                <input
                    ...
                    defaultValue={bookForEdit ? bookForEdit.title : ''}
            ...
            <div className="form-group">
                ...
                <textarea
                    ...
                    type="text"
                    className="form-control"
                    defaultValue={bookForEdit ? bookForEdit.desc : ''}
                    ref={register({ required: true })}
                />
            ...
            <Controller
                ...
                name={'categoryId'}
                defaultValue={bookForEdit ? options[bookForEdit.categoryId] : options[0]}
            />
